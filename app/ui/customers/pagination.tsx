...
export default function CustomerPagination({ totalPages }: { totalPages: number }) {
...
function PaginationNumber({
  ...
  const className = clsx(
    'flex h-10 w-10 items-center justify-center text-sm border',
    {
      ...
      'z-10 bg-green-600 border-green-600 text-white': isActive, // changed color for customers
